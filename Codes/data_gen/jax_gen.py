...
class DDModel(object):
    ...
    def gen_datum(self, a, z, dt=0.001, key: random.PRNGKey = random.PRNGKey(0)):
        ...
        step, uT, _ = lax.while_loop(cond_fun, body_fun=gaussian_walk, init_val=(0, z*a, key))
...
if __name__ == '__main__':
    ddm = DDModel(mu=0.3, sigma=1)
    seed = 10
    data = ddm.gen_data(a=4.0, z=1.5/4.0, key=random.PRNGKey(seed))
    jnp.save('../../Data/data_seed' + str(seed), data)
    print('data saved!')